...
only_toplevel=false
value="
*.include /foss/designs/filter/amp_dev_save.spice
...
if $opSimOnly eq 0
	...
	*alter @V1[PULSE] = [ 0 1.8 0 10u $&t_rf 0 0 0 ]
	...
	plot Amag_dB Aarg ylabel 'Magnitude, Phase' ylimit 0 25

	setplot noise1
	let acgain = onoise_spectrum/inoise_spectrum
	let r1 = sqrt(2)*onoise_r1
...
C {devices/lab_pin.sym} 690 -600 1 0 {name=p3 sig_type=std_logic lab=vipp}
C {devices/lab_pin.sym} 690 -520 3 0 {name=p4 sig_type=std_logic lab=vinn}
...
C {devices/vsource.sym} 1370 -600 3 0 {name=VIOP value=0
}
